                                ...
                                <tbody>
                                        ...
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url({{ asset('/backend_theme/images/gallery/creative/img-1.jpg')}})"></div>
                                                </div>
                                    ...
                                    <tr>										
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url({{ asset('/backend_theme/images/gallery/creative/img-2.jpg')}})"></div>
                                                </div>
                                    ...
                                    <tr>										
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url({{ asset('/backend_theme/images/gallery/creative/img-3.jpg')}})"></div>
                                                </div>
                                    ...
                                    <tr>										
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url({{ asset('/backend_theme/images/gallery/creative/img-4.jpg')}})"></div>
                                                </div>
                                    ...
                                    <tr>										
                                        <td class="pl-0 py-8">
                                            <div class="d-flex align-items-center">
                                                <div class="flex-shrink-0 mr-20">
                                                    <div class="bg-img h-50 w-50" style="background-image: url({{ asset('/backend_theme/images/gallery/creative/img-5.jpg')}})"></div>
                                                </div>
